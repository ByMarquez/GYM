...
//implementar la interfaz CommandLineRunner para la consola, con su metodo run
@SpringBootApplication
public class ZonaFitApplication implements CommandLineRunner {

	@Autowired
	private IClienteServicio clienteServicio;
	//para uso avanzado de la consola, src/main/resources/logback-spring.xml
	...
	public void run(String... args) throws Exception {
		//este metodo run actuara como main, siendo llamado por el mismo
		// SpringApplication."run"(ZonaFitApplication.class, args);
		zonaFitApp();
	}
